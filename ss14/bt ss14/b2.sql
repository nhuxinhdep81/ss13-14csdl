...
begin
    ...
    values (old.employee_id, last_salary, null, now(), 'thông tin lương cuối cùng của họ trước khi bị xóa.');
...
begin
    if new.check_out_time is not null then
        set new.total_hours = timestampdiff(second, new.check_in_time, new.check_out_time) / 3600;
    end if;
end //
delimiter ;
